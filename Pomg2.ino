...
// ***************************************
// DECLARACION DE PARAMETROS Y CONSTANTES
// ***************************************

//DECLARACION DE LOS PINES DE HARDWARE
#define PIN_SCE   4
#define PIN_RESET 3
#define PIN_DC    5
#define PIN_SDIN  6
...
int barWidth = 16; //TAMAÑO DE LA BARRA
int barHeight = 4;
int ballPerimeter = 4; //TAMAÑO DE LA PELOTA
unsigned int bar1X = 0; //COORDENADAS POSICION DE LAS BARRAS
unsigned int bar1Y = 0;
unsigned int bar2X = 0;
unsigned int bar2Y = LCD_Y * 8 - barHeight;
int ballX = 0; //COORDENADAS POSICION DE LA PELOTA
int ballY = 0;
boolean isBallUp = false; //LOGICAS PARA LAS COLISIONES
boolean isBallRight = true;

byte pixels[LCD_X][LCD_Y]; //PARAMETROS DE VISUALIZACION
unsigned long lastRefreshTime;
const int refreshInterval = 150;
byte gameState = 1; //PARAMETROS DE JUEGO
byte ballSpeed = 2;
...
void update(){
  if(gameState == 1){
    ...
    //DETECCION DE BARRAS FUERA DE MARGENES
